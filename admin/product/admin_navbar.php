    ...
    <header class="nav-bar">
        <!------------------navigation-------------------------->    
           <div class="main-nav-brand">
                <a href="../users/users_index.php">Gearbox</a>
           </div>
     ...
     <main class="main_admin_content">
         <section class="section_one">
            ...
            <a href="./categorie_pc.php">Pc</a>
            <a href="./categorie_portable.php">Portable</a>
            <a href="./categorie_imprimante.php">Imprimante</a>
            <a href="./categorie_accessoire.php">Accessoire</a>
            </div>
            <a href="../users/users_index.php">  Clients </a>
            <a href="../users/commande_cl.php"> Commandes </a> 
         </div>
         </section>
