         ...
         <section class="section_two">
            ...
            if (isset($_GET['error'])) {
             ...
             <table id="customers">
                 ...
                 <th>Discription</th>
                 <th>Image</th>
                 <th class="action_but">Actions</th>
                 </tr>
                  <?php 
                  require '../php/dbh.php';        
                    $sql = "SELECT * FROM product where catProd='ACCESSOIRE';";
                        ...
                        if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo '<a href="../php/php_delete_doc/delete_prodaccs_php.php?id='. $row['idProd'] .'" class="button_delete"><img src="../img/img_cat/trash.svg" ></a>';
