            ...
            if (isset($_GET['error'])) {
             ...
             <table id="customers">
                 ...
                 <th>Actions</th>
                  ...
                  <?php 
                  require '../php/dbh.php';        
                    $sql = "SELECT * FROM product where catProd='IMPRIMANTE';";
                        ...
                        if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td class='nomprod'>" . $row['nomProd'] . "</td>";
                                        ...
                                        echo '<a href="../php/php_delete_doc/delete_prodport_php.php?id='. $row['idProd'] .'" class="button_delete"><img src="../img/img_cat/trash.svg" ></a>';
